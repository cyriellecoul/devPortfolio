...
export const translations = {
  en: {
    ...
    hero: {
      ...
      titleName: "I am ready to be part of",
      titleAccent: "your next tech project.",
      description1: "I have ",
      description2: "5 years of experience ",
      description3: " in analysis of QA processes and software development.",
      titleJob1: "Analyst",
      titleJob2: "Developer",
      descriptionJob1: "I am available and open to opportunities as a",
      descriptionJob2: " Quality Assurance (QA) and/or ",
      descriptionJob3: " Front-End & Mobile ",
      ...
      DevOpsTitle: "DEVOPS: ",
      DevOpsSkills: "Agile/Scrum, Git, pipeline CI/CD with GitHub Actions and Sentry, Bitbucket, Confluence, Jira, Figma, Selenium WebDriver",
      viewWork: "Learn more",
    ...
    features: {
      ...
      bulletFeature1List: ["Manual, integration, and automated testing with Selenium WebDriver", "Code Review", "Bug Analysis", "Documentation"],
    ...
    about: {
      ...
      p3: "I am a reliable, involved and sociable person. What I find most fulfilling in development is the gradual realization of digital solutions and the recognition of users through their feedback.",
    },
    projects: {
      title: "Projects",
      ...
      project3desc1: "Transport - Web Portal is a complete platform that combines Angular, HTML, CSS and Javascript.",
    ...
    skills: {
      ...
      backend: "Back-End Development & Database",
  ...
  fr: {
    ...
    hero: {
      ...
      description3: "en analyse des processus en assurance qualité et en développement de logiciels.",
      titleJob1: "Analyste",
      titleJob2: "Développeuse",
      descriptionJob1: "Je suis disponible et ouverte à des opportunités telles que",
      descriptionJob2: " en Assurance Qualité (QA) ",
      descriptionJob3: "Front-End & Mobile ou/et.",
      ...
      languagesMobile: "Android (Java), iOS (Objective-C), React Native",
      DevOpsTitle: "DEVOPS : ",
      DevOpsSkills: "Agile/Scrum, Git, pipeline CI/CD avec GitHub Actions et Sentry, Bitbucket, Confluence, Jira, Figma, Selenium WebDriver",
    ...
    features: {
      ...
      bulletFeature1List: ["Tests manuels, d’intégration et automatisés avec Selenium WebDriver", "Code Review", "Analyse de bugs", "Documentation"],
      bulletFeature2Title: "Collaboration",
    ...
    about: {
      ...
      p3: "Je suis une personne fiable, impliquée et sociable. Ce qui m’épanouit dans le développement, c’est la concrétisation progressive de solutions numériques et la reconnaissance des utilisateur·rice·s à travers leurs retours.",
    },
    projects: {
      title: "Projets",
      ...
      project3desc1: "mTransport Portail est une plateforme Web complète qui associe Angular, HTML, CSS et Javascript.",
    ...
    skills: {
      ...
      backend: "Développement Back-End & Base de données",
