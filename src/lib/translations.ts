...
export const translations = {
  en: {
    ...
    hero: {
      ...
      title: "who creates",
      titleAccent1: "user experiences",
      titleAccent2: "Web sites and mobile Apps",
      titleAccent3: "your next digital project",
      description1: "I have ",
      description2: "5 years of experience ",
      description3: " in software development, ",
  ...
  fr: {
    ...
    hero: {
      ...
      title: "",
      titleAccent1: "en expérience utilisateur",
      titleAccent2: "de sites web et d’applications mobiles",
      titleAccent3: "de votre prochain projet numérique",
      description1: "J'ai ",
